        ...
        <v-col cols="12" md="6">
          <div>
            <div>
              ...
              <v-btn color="#D90368" dark small class="my-5" @click="BuyNow"
                >Buy Now</v-btn
              >
          ...
          <section class="px-4">
            <div class="content content-2">
              <p>
                ...
                Laudantium velit a sint molestiae exercitationem delectus fuga
                quam, reiciendis, ea repellat animi explicabo fugiat amet
                temporibus perferendis itaque accusantium odio eius.
              </p>
            </div>
            <div class="content content-3">
              <p>
                ...
                dolorem pariatur quisquam temporibus.
              </p>
            </div>
          </section>
        </div>
